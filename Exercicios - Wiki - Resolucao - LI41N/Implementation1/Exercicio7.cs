...
namespace Exercicios_Implementacao1
{
    class Student
    {
        //public static readonly Student s = new Student(123, "A");
        public static readonly Student s;


        //[Validator("NumberGreaterThan20000", /*new Student(123, "A")*/ new object())] // Nao funciona porque so podem
        // ser passados valores que sejam calculados em compile-time
        //[Validator("NumberGreaterThan20000", new int[]{ 1, 2, 3 })] // OK
        //[Validator("NumberGreaterThan20000", s)] // Erro, s so e' criado em tempo de execucao
